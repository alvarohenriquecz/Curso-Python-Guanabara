...
teste.append(40) # Adiciona o numero inteiro 40 ao final da lista "teste"

galera = list() # Cria uma nova lista vazia "galera"
galera.append(teste) # Adiciona a propria lista "teste" (e nao uma copia) a lista composta "galera"
...
galera.append(teste) # Adiciona novamente a propria lista "teste" (ja modificada) a lista composta "galera"
print(galera) # Exibe [['Maria], 22], ['Maria', 22] (e nao [['Gustavo', 40], ['Maria', 22]])
