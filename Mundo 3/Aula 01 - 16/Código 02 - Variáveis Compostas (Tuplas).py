a = (2, 5, 4) # Tupla "a"
b = (5, 8, 1, 2) # tupla "b"
c = a + b # Crie uma nova tupla "c" contendo os elementos da tupla "a" e em seguida os da "b", sem soma-los
d = b + a # Cria uma nova tupla "d" contendo os elementos da tupla "b" e em seguida os da "a", sem soma-las
