...
for c in range(1, 4 + 1):
    msg1 = 'Digite o nome da N {} (ex: Maria):'.format(c)
    msg2 = 'Digite a idade da pessoa N {} (ex: 25): '.format(c)
    msg3 = 'Digite o sexo da pessoa N {} (H para homem ou M para mulher): '.format(c)
...
if nomemaisvelho == '':
    print('Nao tem nenhum homem no grupo')
else:
    print('O homem mais velho do grupo tem {} anos e se chama {}.'.format(maisvelho, nomemaisvelho))

if mulheresjovens == 0:
    print('Nao tem nenhuma mulher com menos de 20 anos no grupo.')
