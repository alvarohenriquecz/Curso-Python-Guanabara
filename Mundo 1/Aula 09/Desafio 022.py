...
> Quantas letras ao todo (sem onsiderar os espacos).
...
print('\nNome em letras maiusculas: {}'.format(nome.upper()))
print('Nome em letras minusculas: {}'.format(nome.lower()))
print('Quantidade total de letras (sem contar os espacos): {}'.format(nome_sem_espacos))
