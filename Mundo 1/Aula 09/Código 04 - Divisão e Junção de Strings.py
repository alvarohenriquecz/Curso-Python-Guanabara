...
frase_separada = frase.split() # Separa cada palavra da string em uma lista; os indices sao refeitos
...
print(frase_junta_hifen) # Exibe a string novamente, desta vex com "-" no lugar dos espaços

frase_junta_espaco = ' '.join(frase_separada) # Junta as palavras separadas na lista usando um espaço como divisor 
print(frase_junta_espaco) # Exibe a string junta novamente, com o espaco sendo divisor, como  na original
